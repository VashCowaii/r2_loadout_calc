...
for (let i = 0; i < greatFlagsLength; i++) {
    greatFlagIndex[greatFlagsKnowerOfAll[i]] = i;
}
...
const propertyImagePaths = {
    ...
    "Aggro": {
        ...
        "sets": {
            [greatTableIndex["CharacterAggroBase"]]: {
                "display": "Aggro",
                "specific": "Aggro Base",
                "unit": ""
            },
...
let basicShorthand = {
    ...
    findStatObject(statName) {
        ...
        for (let groupKey of groupKeys) {
            ...
            //     console.log(currentGroup.sets[statName])
