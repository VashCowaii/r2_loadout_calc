let modifiersExtraEffects = [
  ...
  },
  {
    ...
    "desc": "A Shield that offsets DMG taken by all allies. Before the Shield is depleted or its effect expires, enemy targets' attacks won't reduce the Shielded ally targets' HP."
  },
  {
  ...
  {
    "name": "Ambrosial Arbor branch",
    "desc": "\"Twig of Wintry Wind,\" \"Twig of Marple Leaf,\" \"Twig of Glorious Blooms,\" and \"Twig of Lavish Fruits\" are collectively known as the \"Ambrosial Arbor branch.\""
  },
  {
    "name": "Abominations of Abundance",
    "desc": "In this battle, the \"Mara-Struck Soldier\" and \"Disciples of Sanctus Medicus: Ballistarius\" summoned by the \"Unwaning Ageless Immortal\" are collectively referred to as \"Abominations of Abundance.\""
  },
  {
    "name": "Halo",
    "desc": "\"Halo\" effects remain active on specific units on the field. Multiple identical \"Halo\" effects cannot stack."
  },
  {
  ...
  {
    "name": "Bloodlust",
    "desc": "All enemy units that can enter \"Moon Rage\" will share \"Bloodlust\" stacks. When enemy units that can enter \"Moon Rage\" join the battle, the same number of \"Bloodlust\" stacks will be applied to them. At the end of the turn, if all enemies that can enter \"Moon Rage\" have been defeated, clears all \"Bloodlust\" stacks."
  },
  {
    "name": "Moon Rage",
  ...
  {
    "name": "Terrified",
    "desc": "Unable to take action until the start of this unit's next turn."
  },
  {
    "name": "Moon Rage",
  ...
  {
    "name": "Dissociation",
    "desc": "Debuff caused by specific Blessings of Remembrance.\\nThe enemy is considered Frozen and will be unable to act for a designated number of turns. After Freeze is removed, deals Ice Additional DMG equal to #1[i]% of the enemy target's Max HP.",
    "params": [
      0.3
    ]
  },
  {
    "name": "Aftertaste",
    "desc": "Follow-Up ATK DMG of a random Type caused by specific Blessings of Elation."
  },
  {
    "name": "Critical Boost",
    "desc": "Buff brought by certain Blessings of The Hunt.\\nFor each stack, increases CRIT Rate by #1[i]% and CRIT DMG by #2[i]%. Stacks up to #3[i] time(s). This buff can be transferred to ally targets when the next turn starts. Stacks reset when any ally target is attacked.",
    "params": [
      0.06,
      0.12,
      8
  ...
  {
    "name": "Grit",
    "desc": "Buff brought by certain Blessings of Destruction.\\nFor each stack, increases ATK by #1[i]% and DEF by #2[i]%. Stacks up to #3[i] time(s).",
    "params": [
      0.03,
      0.03,
      35
  ...
  },
  {
    ...
    "desc": "CRIT DMG increases by an amount equal to #1[i]% of CRIT Rate. Gains one extra turn after defeating the enemy target. This effect cannot trigger repeatedly.",
    "params": [
      0.8
    ]
  },
  ...
  {
    "name": "Suspicion",
    "desc": "Debuff brought by certain Blessings of Nihility.\\nIncreases DoT taken by #1[i]%. Stacks up to #2[i] time(s), but loses #3[i] stack(s) at the end of the turn.",
    "params": [
      0.01,
      99,
      2
  ...
  {
    "name": "Dewdrop",
    "desc": "An effect that can be charged up, formed by specific Blessings of Abundance.\\nThe Charge cannot exceed #1[i]% of the character's Max HP. Dewdrop ruptures after the character attacks, dealing Additional DMG to the attacked enemy target based on Charge value.",
    "params": [
      5
    ]
  },
  ...
  {
    "name": "Metamorphosis",
    "desc": "During an attack, for every Skill Point consumed or recovered, the attack can ignore #1[i]% of the enemy target's all-Type RES. This effect can stack up to #2[i] times.",
    "params": [
      0.1,
      2
    ]
  ...
  },
  {
    ...
    "desc": "When Resonance Extrapolation: \"The Hunt\" takes action, it deals Wind DMG to all allies based on the boss' Type. Actions taken by any unit will advance the Resonance's action."
  },
  {
    "name": "Formation Extrapolation: Bow and Arrow",
    "desc": "When Resonance Extrapolation deals DMG to ally targets with HP below #1[i]% of their Max HP, its CRIT Rate increases by 100% and CRIT DMG increases to #2[i]%.",
    "params": [
      0.5,
      0.4
    ]
  },
  {
    ...
    "desc": "The boss immediately takes action after the Resonance Extrapolation's attack."
  },
  {
    "name": "Resonance Extrapolation: \"Destruction\"",
    "desc": "When Resonance Extrapolation: \"Destruction\" takes action, it deals Fire DMG to all allies. Actions taken by any unit will advance the Resonance's action."
  },
  {
    "name": "Formation Extrapolation: Extreme Helium Flash",
    "desc": "After Resonance Extrapolation attacks, reduces character's DEF by #1[i]% for #2[i] turn(s).",
    "params": [
      0.3,
      2
    ]
  },
  {
    ...
    "desc": "After an enemy target is defeated, Resonance Extrapolation's action advances by #1[i]%.",
    "params": [
      0.5
    ]
  },
  {
    ...
    "desc": "When Resonance Extrapolation: \"Nihility\" takes action, it has a chance to inflict DoT effects on the characters. All units' actions advance Resonance's action."
  },
  {
    "name": "Formation Extrapolation: The Doubtful Fourfold Root",
    "desc": "Resonance Extrapolation has a higher chance of inflicting DoT effects for the next #1[i] turn(s).",
    "params": [
      1
    ]
  },
  {
    ...
    "desc": "When allies receive DMG from a DoT effect, Resonance Extrapolation's action advances."
  },
  {
    "name": "Resonance Extrapolation: \"Abundance\"",
    "desc": "When Resonance Extrapolation: \"Abundance\" takes action, it restores HP for all enemies. All units' actions advance Resonance's action."
  },
  {
    "name": "Formation Extrapolation: Anicca",
    "desc": "When Resonance Extrapolation takes action, it dispels #1[i] debuff(s) from each enemy.",
    "params": [
      4
    ]
  },
  {
    ...
    "desc": "When Resonance Extrapolation takes action, it increases all enemies' ATK by #1[i]% for #2[i] turn(s).",
    "params": [
      0.3,
      1
    ]
  ...
  {
    "name": "Murmur",
    "desc": "When enemy targets enter combat, they are inflicted with this state. This is considered as the Wind Shear state. At the start of a turn, deals Wind DoT equal to the Charge value, and clears any Charge values that exceed the threshold. The threshold is equal to #1[i]% of the sum of all ally characters' ATK.",
    "params": [
      50
    ]
  },
  ...
  {
    "name": "Harmonize",
    "desc": "Increases the holder's Break DMG taken by #1[i]%. When entering or exiting the Weakness Broken state, take Quantum Break DMG equal to #2[i]% base DMG for each stack of \"Harmonize,\" up to #3[i] stack(s). Cleared when recovering from Weakness Break.",
    "params": [
      0.25,
      0.6,
      40
  ...
  {
    "name": "Spores — Trait",
    "desc": "For each Skill Point consumed by characters, inflicts 1 \"Spore\" to #1[i] random enemy target(s). Every Blessing of Propagation in possession provides a #2[i]% chance to apply 1 \"Spore\" to #4[i] additional random enemy target(s). A max of #3[i] Blessings of Propagation can be taken into account.",
    "params": [
      1,
      0.1,
      8,
  ...
  },
  {
    ...
    "desc": "When entering combat, \"Soul Chrysalis\" gains #1[i]% Charge. For every Skill Point consumed, #2[i]% Charge is gained. Every Blessing of Propagation in possession increases ally targets' Basic ATK/Skill DMG by #3[i]%. A max of #4[i] Blessings of Propagation can be taken into account.",
    "params": [
      0.6,
      0.08,
      0.1,
  ...
  {
    "name": "Dealer — Trait",
    "desc": "The \"Dealer\" gains 1 Charge permanently every time it takes action. For every 1 Blessing of Elation owned, the \"Dealer's\" DMG multiplier increases by #1[i]% of its original value. Up to a max of #2[i] Blessing(s) of Elation will be taken into account for this effect.",
    "params": [
      0.3,
      8
    ]
  ...
  {
    "name": "Embrittlement",
    "desc": "SPD decreases by #1[i]%. When #2[i] stacks of \"Embrittlement\" are present, removes \"Embrittlement\" after any character uses an ability with a high chance of becoming Frozen, lasting for #3[i] turn(s).",
    "params": [
      0.1,
      8,
      1
  ...
  {
    "name": "Chord",
    "desc": "Removed after using a Basic Attack and deals DMG to the attacked target based on the number of stacks."
  },
  {
    "name": "Base DMG",
    "desc": "The higher the enemy target's level and the higher the Threshold Protocol, the higher the base DMG dealt."
  },
  {
  ...
  },
  {
    ...
    "desc": "After receiving an attack from a Lightning-Type Ultimate, further deals Lightning Additional DMG."
  },
  {
    "name": "Spinning Back Fist",
    "desc": "Units that are both Weakness Broken and Burned will receive Fire Additional DMG after they are attacked."
  },
  {
    "name": "Jawbreaker",
    "desc": "After Frozen enemies are attacked by ally units, receives Ice Additional DMG based on the target's ATK."
  },
  {
    "name": "Gloomfire",
    "desc": "For a certain number of turns, takes Fire DMG that is based on the character's ATK at the start of each turn."
  },
  {
    "name": "Quake",
    "desc": "Additional DMG dealt by the Stage Buff cannot defeat the enemy target if triggered upon being attacked."
  },
  {
    "name": "Overflow DMG",
  ...
  {
    "name": "Detonate",
    "desc": "Every time the holder is attacked, they additionally take a fixed amount of DMG based on the number of \"Detonate\" stacks. The DMG increases with the number of Bomb stacks. The effect is dispelled when the holder takes action."
  },
  {
    "name": "Galefury",
    "desc": "When characters have \"Galefury,\" consumes one of its stacks at the end of their turn and advances their action by 100%."
  },
  {
    "name": "Shudder",
    "desc": "The Trotter takes additional DMG.",
    "params": [
      0.1
    ]
  },
  ...
  {
    "name": "Bellow",
    "desc": "Each stack of \"Bellow\" increases the DMG dealt by the holder."
  },
  {
    "name": "Blood Rage",
    "desc": "Each stack of \"Blood Rage\" increases the holder's CRIT Rate and CRIT DMG."
  },
  {
    "name": "Summon",
  ...
  {
    "name": "AoE",
    "desc": "Weapons of this type will deal AoE DMG to multiple adjacent targets."
  },
  {
    "name": "Focus",
  ...
  },
  {
    ...
    "desc": "After using a single-target ability, re-selects the target and uses the ability again."
  },
  {
    "name": "Combat Stance",
    "desc": "The Silver Knight of Virtuous Gallantry will change their state throughout the battle:\\n\"Chivalric Wrath\": Summons \"Speartip\" statues and decreases all DMG taken by this unit. When 4 statues are on the field, this unit enters the Toughness Protection state.\\n\"Golden Harvest\": Summons \"Shield\" statues and increases all DMG dealt by this unit.\\n\"Medal of Elegance\": Summons \"The Honored\" statues. When statues exist on the field, this unit cannot be selected as a target."
  },
  {
    "name": "Transfer",
  ...
  {
    "name": "Part",
    "desc": "Attacks to the parts will also reduce HP on the main body by an equal amount"
  },
  {
    "name": "Transmit",
  ...
  {
    "name": "Type Infusion",
    "desc": "Ally targets in the \"Type Infusion\" state can deal Toughness Reduction to specific targets."
  },
  {
    "name": "Prana-Siphon",
    "desc": "Ally targets in the \"Prana-Siphon\" state have their Max HP reduced."
  },
  {
    "name": "Points",
    "desc": "When the enemy target's points are higher than the team's, the enemies receive greatly reduced DMG and gain Toughness Protection. When ally characters attack enemy targets with fewer points than themselves, the higher the allies' points, the higher the DMG taken by enemy targets. The maximum number of points is 100."
  },
  {
    "name": "Doubled Summons",
    "desc": "Leaves the field after appearing for a certain duration. Defeating this summon will cause allies' points to double."
  },
  {
    "name": "Share",
  ...
  {
    "name": "Switch Tally",
    "desc": "Unit in the \"Classroom Channel\" state will gain 1 point in the Switch Tally when attacked. When the Switch Tally hits the max, it switches the unit to the \"Off-Class Channel\" state, reduces the Boss Mirage's Toughness, and immediately obtains that unit's \"Off-Class Channel\" reward 1 time."
  },
  {
    "name": "Insect Egg",
  ...
  {
    "name": "Growth Hormone",
    "desc": "Every stack of \"Growth Hormone\" increases ATK by a certain amount, stacking up to 3 times. When 3 stacks are reached, Swarm summons will unlock bonus abilities."
  },
  {
    "name": "Lunar Devourer",
    "desc": "While in this state, the Boss Mirage will use \"Going Solo,\" and an ally character must be selected to engage in \"Going Solo\" against Boss Mirage. During \"Going Solo,\" apart from the selected character and their summoned target, all other ally targets will become Departed. This state is dispelled when the Boss Mirage becomes Weakness Broken."
  },
  {
    "name": "Toughness Lock",
