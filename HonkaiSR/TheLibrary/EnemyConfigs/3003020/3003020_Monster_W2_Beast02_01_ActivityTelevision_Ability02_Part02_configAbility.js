const configAbility = {
  "fileName": "3003020_Monster_W2_Beast02_01_ActivityTelevision_Ability02_Part02",
  "abilityType": null,
  "energy": null,
  "toughnessList": null,
  "parse": [
              ...
              "failed": [
                {
                  ...
                  "AttackScaling": {
                    "DamageType": "Ice",
                    "Damage": {
                      "operator": "Variables[0] (UnusedUnderThisBase_265) || RETURN",
                      "displayLines": "UnusedUnderThisBase_265",
                      "constants": [],
                      "variables": [
                        "UnusedUnderThisBase_265"
                      ]
                    },
                    "dmgFormula": "Max HP Scaling",
                    "dmgFormulaFinal": "Converted DMG Base",
    ...
    "Trigger: Attack End",
    {
      ...
      "set": {
        "operator": "Variables[0] (Fire4_Flag) || RETURN",
        "displayLines": "Fire4_Flag",
        "constants": [],
        "variables": [
          "Fire4_Flag"
        ]
