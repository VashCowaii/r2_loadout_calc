const configAbility = {
  "fileName": "4014013_Monster_W4_Hearse_IF_Ability03_Part02",
  "abilityType": null,
  "energy": null,
  "toughnessList": null,
  "parse": [
    ...
    },
    {
      ...
      "value": {
        "operator": "Variables[0] ({[Skill03[0]]}) || Variables[1] (Skill03ExtraCount) || Variables[2] (UnusedUnderThisBase_541) || MUL || ADD || RETURN",
        "displayLines": "({[Skill03[0]]} + (Skill03ExtraCount * UnusedUnderThisBase_541))",
        "constants": [],
        "variables": [
          "{[Skill03[0]]}",
          "Skill03ExtraCount",
