...
const compositeAbilityObject = {
  ...
  "abilityObject": {
    ...
    "4034020_Monster_W4_Phainon_BattlePerform2": {
      "fileName": "4034020_Monster_W4_Phainon_BattlePerform2",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [
    ...
    "4034020_Monster_W4_Phainon_BattlePerform1": {
      "fileName": "4034020_Monster_W4_Phainon_BattlePerform1",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [
              ...
              "execute": [
                ...
                },
                {
                  ...
                  "conditions": {
                    ...
                    "compareType": ">=",
                    "value2": {
                      "operator": "Variables[0] ({[PassiveSkill01[0]]}) || Variables[1] (DV_InitDelay) || ADD || RETURN",
                      "displayLines": "({[PassiveSkill01[0]]} + DV_InitDelay)",
                      "constants": [],
                      "variables": [
                        "{[PassiveSkill01[0]]}",
                        "DV_InitDelay"
