...
const compositeAbilityObject = {
  "fullCharacterName": 5023021,
  "trimCharacterName": 5023021,
  "abilityList": [
    "5023021_Modifiers",
    "5023021_Monster_W5_Eater_Ability03_Part02_FateRin",
    "5023021_Monster_W5_Eater_Ability03_Part01_FateRin",
    "5023021_Monster_W5_Eater_PassiveAbilityInitiate",
    "5023021_Monster_W5_Eater_Ability04_Part02",
    "5023021_Monster_W5_Eater_Ability04_Part01",
    ...
    "5023021_Monster_W5_Eater_Ability03_Part03",
    "5023021_Monster_W5_Eater_Ability03_Part03_FateRin",
    "5023021_Handling"
  ],
  "abilityObject": {
    "5023021_Modifiers": {
      "fileName": "5023021_Modifiers",
      ...
      "parse": [
          ...
          "execute": [
            ...
            },
            {
              ...
              "execute": [
                {
                  "name": "Abort Ability Use",
                  "abilityName": "Monster_W5_Eater_Ability03_Part01_FateRin",
                  "abilitySource": {
                    "name": "Target Name",
                    "target": "{{Modifier Holder}}"
                  }
                },
                {
                  ...
                  "passed": [
                    {
                      "name": "Add Stage Ability",
                      "abilityName": "Monster_W5_Eater_Ability03_Part03_FateRin"
                    },
                    {
                      "name": "Inject Ability Use",
                      "abilityName": "Monster_W5_Eater_Ability03_Part03_FateRin",
                ...
                },
                {
                  ...
                  "passed": [
                    ...
                    },
                    {
                      ...
                      "abilityTarget": {
                        "name": "Target Name",
                        "target": "{{Player Team All}}.[[randomize]].[[index0]]"
                      },
                      "priorityTag": "EnemyBuffOthers",
                      "valuePerStack": {
                        "Ability03_Attack": {
              ...
              "execute": [
                {
                  ...
                  "passed": [
                    ...
                    },
                    {
                      ...
                      "variableName": "MDF_Attack",
                      "value": {
                        "operator": "Variables[0] (MDF_CurrentCount) || Variables[1] ({[Skill02[2]]}) || DIV || Variables[2] (MDF_LoseAttack) || MUL || RETURN",
                        "displayLines": "((MDF_CurrentCount / {[Skill02[2]]}) * MDF_LoseAttack)",
                        "constants": [],
                        "variables": [
                          "MDF_CurrentCount",
                          "{[Skill02[2]]}",
                    ...
                    },
                    {
                      ...
                      "ifTargetFound": [
                        ...
                        },
                        {
                          ...
                          "valuePerStack": {
                            "MDF_Attack": {
                              "operator": "Variables[0] (MDF_CurrentCount) || Variables[1] ({[Skill02[2]]}) || DIV || Variables[2] ({[Skill02[3]]}) || MUL || RETURN",
                              "displayLines": "((MDF_CurrentCount / {[Skill02[2]]}) * {[Skill02[3]]})",
                              "constants": [],
                              "variables": [
                                "MDF_CurrentCount",
                                "{[Skill02[2]]}",
              ...
              "execute": [
                {
                  ...
                  "conditions": {
                    "name": "Compare: Parameter String",
                    "compareType": "=",
                    "value2": "Monster_W5_Eater_Ability03_Part01_FateRin"
                  },
                  "passed": [
                    "Modifier Deletes Itself"
                  ]
          ...
          "execute": [
            {
              ...
              "execute": [
                ...
                },
                {
                  ...
                  "from": {
                    "name": "Target Name",
                    "target": "{{Player Team All}} - {{Modifier Holder}}"
                  },
                  "maxTargets": 1,
                  "conditions": {
                    "name": "Has Modifier",
              ...
              "execute": [
                {
                  ...
                  "variableName": "MMonster_W5_Eater_00_Skill02_Ate_FateRin_DynamicTarget"
                },
                {
                  "name": "Define Custom Variable with Stat",
                  "target": {
        ...
        {
          "name": "Modifier Construction",
          "for": "<a class=\"gModGreen\" id=\"mod__1765185548\">Enemy_W5_Eater_Ability02_Ate_Sub_FateRin</a>",
          "stackType": "ReplaceByCaster",
          "addStacksPerTrigger": 1,
          "execute": [
            {
              ...
              "execute": [
                {
                  ...
                  "variableName": "MMonster_W5_Eater_00_Skill03_Attack_FateRin_DynamicTarget"
                },
                {
                  "name": "Stack Target Stat Value",
                  "target": {
    ...
    "5023021_Monster_W5_Eater_Ability03_Part02_FateRin": {
      "fileName": "5023021_Monster_W5_Eater_Ability03_Part02_FateRin",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [
    ...
    "5023021_Monster_W5_Eater_PassiveAbilityInitiate": {
      "fileName": "5023021_Monster_W5_Eater_PassiveAbilityInitiate",
    ...
    "5023021_Monster_W5_Eater_Ability04_Part02": {
      "fileName": "5023021_Monster_W5_Eater_Ability04_Part02",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [
    ...
    "5023021_Monster_W5_Eater_Ability04_Part01": {
      "fileName": "5023021_Monster_W5_Eater_Ability04_Part01",
      "childAbilityList": [
        "5023021_Monster_W5_Eater_Ability04_Camera",
        "5023021_Monster_W5_Eater_Ability04_Part01",
        "5023021_Monster_W5_Eater_Ability04_Part02"
      ],
    ...
    "5023021_Monster_W5_Eater_Ability01_Part02_FateRin": {
      "fileName": "5023021_Monster_W5_Eater_Ability01_Part02_FateRin",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [
    ...
    "5023021_Monster_W5_Eater_Ability03_Part03": {
      "fileName": "5023021_Monster_W5_Eater_Ability03_Part03",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [
    ...
    "5023021_Monster_W5_Eater_Ability03_Part03_FateRin": {
      "fileName": "5023021_Monster_W5_Eater_Ability03_Part03_FateRin",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [
