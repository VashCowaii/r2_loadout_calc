const configAbility = {
  "fileName": "4014018_Monster_W4_Nikadory_Ability06_Part02",
  "abilityType": null,
  "energy": null,
  "toughnessList": null,
  "parse": [
      ...
      "passed": [
        {
          ...
          "value": {
            "operator": "Variables[0] ({[Skill06[1]]}) || Variables[1] (Skill06Count) || DIV || RETURN",
            "displayLines": "({[Skill06[1]]} / Skill06Count)",
            "constants": [],
            "variables": [
              "{[Skill06[1]]}",
              "Skill06Count"
