const configAbility = {
  ...
  "parse": [
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Evanescia: Memosprite",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Add Target by Pseudo-Character Partner",
          "identifier": "Evanescia_Servant_B"
        }
      ]
    },
    {
      "name": "Target Configuration",
      "nameTarget": "Evanescia: Slain Targets",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Ashveil: Parasite Target",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
          "Sequence": [
            {
              "name": "Target Name",
              "target": "{{Enemy Team All(with Unselectable)}}.[[living]]"
            },
            {
              "name": "Target Filter",
              "conditions": {
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Ripper: Skill03 Camera Target",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Join Targets",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Ripper: Skill03 Target",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "@Sparxiecon APOC: Prime-Field Targets",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Aggressive Reading: PowerOut Target",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Spirit Theif: Remove",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
                ...
                "conditionList": [
                  {
                    ...
                    "modifier": "<a class=\"gModGreen\" id=\"-906898841\">Enemy_W4_Mascot_ListenCorrectInteract_Activity_DeathMark</a>[<span class=\"descriptionNumberColor\">Brainteaser</span>]"
                  }
                ]
              }
            }
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Xuanlu: Servant Zone 03",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Xuanlu: Servant Zone 02",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Xuanlu: Servant Zone 01",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
    ...
    {
      "name": "Target Configuration",
      "nameTarget": "Elation: Player Team with Unselectables with Elation Skills",
      "isTargetOperator": false,
      "execute": [
        {
          "name": "Target Sequence",
