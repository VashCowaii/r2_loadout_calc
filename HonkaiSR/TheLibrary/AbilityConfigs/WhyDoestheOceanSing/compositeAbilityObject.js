const compositeAbilityObject = {
  "fullCharacterName": "Why Does the Ocean Sing",
  "trimCharacterName": "WhyDoestheOceanSing",
  "abilityList": [
    "WhyDoestheOceanSing_Ability23047"
  ],
  "fixedStats": {
    "1": {
      "EffectHitRate": 0.4
                  ...
                  "passed": [
                    {
                      ...
                      "value": {
                        "operator": "Variables[0] (MDF_TotalDotDamageAddRatio) || RETURN",
                        "displayLines": "MDF_TotalDotDamageAddRatio",
                        "constants": [],
                        "variables": [
