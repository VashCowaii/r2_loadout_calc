...
const compositeAbilityObject = {
  ...
  "abilityObject": {
    ...
    "-838314705_StrongChallengeEX_Environment_StageAbility_017": {
      "fileName": "-838314705_StrongChallengeEX_Environment_StageAbility_017",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [],
      "whenAdded": [
        {
          ...
          "modifier": "<a class=\"gModGreen\" id=\"887845537\">MStrongChallengeEX_Environment_StageAbility_LE_017</a>"
        }
      ],
      "references": [
        {
          "name": "Modifier Construction",
          "for": "<a class=\"gModGreen\" id=\"mod__-982484109\">MStrongChallengeEX_Environment_StageAbility_BOSS_017</a>",
          "stackType": "ReplaceByCaster",
          "execute": [
            {
              "eventTrigger": "Take Damage Start [Owner]: Any",
        ...
        {
          "name": "Modifier Construction",
          "for": "<a class=\"gModGreen\" id=\"mod__887845537\">MStrongChallengeEX_Environment_StageAbility_LE_017</a>",
          "execute": [
            {
              "eventTrigger": "When Stacking/Receiving Modifier",
              "execute": [
                  ...
                  "passed": [
                    {
                      ...
                      "modifier": "<a class=\"gModGreen\" id=\"-982484109\">MStrongChallengeEX_Environment_StageAbility_BOSS_017</a>",
                      "valuePerStack": {
                        "MDF_PropertyValue": {
    ...
    "-838314705_StrongChallengeEX_Environment_StageAbility_016": {
      "fileName": "-838314705_StrongChallengeEX_Environment_StageAbility_016",
      "abilityType": null,
      "energy": null,
      "toughnessList": null,
      "parse": [],
      "whenAdded": [
        {
          ...
          "modifier": "<a class=\"gModGreen\" id=\"871067918\">MStrongChallengeEX_Environment_StageAbility_LE_016</a>"
        }
      ],
      "references": [
        {
          "name": "Modifier Construction",
          "for": "<a class=\"gModGreen\" id=\"mod__-999261728\">MStrongChallengeEX_Environment_StageAbility_BOSS_016</a>",
          "stackType": "ReplaceByCaster",
          "execute": [
            {
              "eventTrigger": "Take Damage Start [Owner]: Any",
        ...
        {
          "name": "Modifier Construction",
          "for": "<a class=\"gModGreen\" id=\"mod__871067918\">MStrongChallengeEX_Environment_StageAbility_LE_016</a>",
          "execute": [
            {
              "eventTrigger": "When Stacking/Receiving Modifier",
              "execute": [
                  ...
                  "passed": [
                    {
                      ...
                      "modifier": "<a class=\"gModGreen\" id=\"-999261728\">MStrongChallengeEX_Environment_StageAbility_BOSS_016</a>",
                      "valuePerStack": {
                        "MDF_PropertyValue": {
                          "operator": "Variables[0] (#ADF_1) || RETURN",
                          "displayLines": "#ADF_1",
